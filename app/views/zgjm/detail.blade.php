...
<head>
<meta charset="utf-8">
<title>{{$data['data']->jmtitle}}_周公解梦_趣历史</title>
<meta name="Keywords" content="{{$data['data']->jmtitle}},周公解梦,周公解梦大全,周公解梦查询，免费周公解梦"/>
<meta name="Description" content="{{$data['data']->jmtitle}}是什么意思{{$data['data']->jmtitle}}有什么寓意，{{$data['data']->jmtitle}}究竟好不好呢，很多人都有这方面的解梦疑惑，2280周公解梦专门精心整理了{{$data['data']->jmtitle}}相关的内容，为您免费解梦！" />
...
<input type="text" class="zbjmB1SearchText" name="skey">
		...
		<div class="zgjmlist">
	    <h3 class="zbjmConTitle"><i></i>{{$data['data']->jmtitle}}</h3>
			<div class="zbjmB1WenHuaCOn" style="padding:10px;">
				{{$data['data']->jmcon}}
			</div>

         </div>
         
         <div class="zbjmB1Story zgjmBg2" style="margin-top:10px;">
			<h3 class="zbjmConTitle"><i></i>相关解梦</h3>
			<ul class="clearfix">
            	@foreach($data['relate'] as $val)
