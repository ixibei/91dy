        ...
        <div class="af-list">
            ...
            <dl class="cf">
                ...
                <dd>
    	            ...
    	            <span class="c @if($val->id == $param[0]) on @endif"><a href="{{ URL::route('movieCategorySearch', [$uri,$val->id,$param[1],$param[2],$param[3],1] ) }}">{{ $val->name }}</a></span>
                    @endforeach
                </dd>
            </dl>
            <dl class="cf">
                ...
                <dd>
					...
					@foreach($arr as $val)
                    <span class="c @if($val == $param[1]) on @endif"><a href="{{ URL::route('movieCategorySearch', [$uri,$param[0],$val,$param[2],$param[3],1] ) }}">{{ $val }}</a></span>
                    @endforeach
                </dd>
            </dl>
            <dl class="star-list cf">
                ...
                <span class="c @if($param[2] == 0) on @endif"><a href="{{ URL::route('movieCategorySearch', [$uri,$param[0],$param[1],0,$param[3],1] ) }}">全部</a></span>
                    ...
                    <span class="c @if($val->id == $param[2]) on @endif"><a href="{{ URL::route('movieCategorySearch', [$uri,$param[0],$param[1],$val->id,$param[3],1] ) }}">{{ $val->name }}</a></span>
                    @endforeach                
                </dd>
            </dl>
        </div>
