...
<div id="contentwrapper" class="contentwrapper">
    ...
    <div class="tableoptions">
        ...
        <button class="radius3" onclick="option('keyword','{{URL::to('base/option')}}')">应 用</button>
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb">
    ...
    <tr @if($key % 2 == 1) class="group" @endif>
      ...
      <td class="center">{{ HTML::link(URL::action("Admin_KeywordsController@getEdit",array($val->id)), '编辑') }}</td>
    </tr>
    @endforeach
      </tbody>
  </table>
...
function searchKeywords(obj){
	...
	var url = "{{ url('keywords/index') }}?keywords="+keywords;
	location.href = url;
}
</script>  
@stop