...
class BootstrapPresenter {
	...
	public function getPageRange($start, $end)
	{
		...
		for ($page = $start; $page <= $end; $page++)
		{
			...
			{
				$pages[] = '<a href="#"><span class="paginate_active">'.$page.'</span></a>';
			}
			else
			{
	...
	public function getPrevious($text = 'Previous')
	{
		...
		{
			return '<a href="#"><span class="previous paginate_button paginate_button_disabled">'.$text.'</span></a>';
		}
		else
		{
			$url = $this->paginator->getUrl($this->currentPage - 1);

			return '<a href="'.$url.'"><span class="paginate_button">'.$text.'</span></a>';
		}
	}
	...
	public function getNext($text = 'Next')
	{
		...
		{
			return '<a href="#"><span class="next paginate_button" id="dyntable2_next">'.$text.'</span></a>';
		}
		else
		{
			$url = $this->paginator->getUrl($this->currentPage + 1);
	...
	{
		return '<a href="#"><span class="disabled paginate_button">...</span></a>';
	}
	...
	public function getLink($page)
	{
		...
		return '<a href="'.$url.'"><span class="paginate_button">'.$page.'</span></a>';
	}
